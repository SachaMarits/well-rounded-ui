...
export default function Breadcrumbs() {
  ...
  const breadcrumbs = (location: { pathname: string }) => {
  ...
  return <p className={breadcrumbs(location) !== welcomeMessage ? "text-capitalize" : ""}>{breadcrumbs(location)}</p>;
}
